...
(function() {
    ...
    (function() {
        ...
        a.nd = "\154\x6f";
        a.jG = "\150\157";
        a.hf = new window["\122\145\147\x45\170\160"]("\136\x77\x77\x77\x5c\x2e");
        a.hg = new window["\x52\x65\x67\x45\170\x70"]("\x3a\134\x64\053\x24");
        a.lS = function(q) {
            ...
            bz: function(q) {
                q.on('appReady', function() {
                    ...
                    q.connector.sendCommand('Init', s, function(t) {
                        ...
                        var v = "\x43\157\156\x6e\145\x63\164\157\x72\057\103\x6f\x6e\156\145\143\164\157\x72\111\156\x66\157\057";
                        a.ed = t.selectSingleNode(v + "\x40\x73").value;
                        a.bF = t.selectSingleNode(v + "\100\143").value + '----';
                        q.config.thumbsEnabled = t.selectSingleNode(v + "\x40\x74\x68\x75\x6d\x62\x73\105\x6e\141\x62\154\x65\x64").value == 'true';
                        q.config.thumbsDirectAccess = false;
                        if (q.config.thumbsEnabled) {
                            u = t.selectSingleNode(v + "\100\164\150\165\155\142\x73\x55\x72\x6c");
                            if (u) q.config.thumbsUrl = u.value;
                            u = t.selectSingleNode(v + "\100\x74\x68\x75\155\x62\163\104\151\x72\x65\143\x74\x41\x63\143\145\163\x73");
                            if (u) q.config.thumbsDirectAccess = u.value == 'true';
                        }
                        q.config.imagesMaxWidth = parseInt(t.selectSingleNode(v + "\x40\x69\x6d\147\x57\151\144\x74\x68").value, 10);
                        q.config.imagesMaxHeight = parseInt(t.selectSingleNode(v + "\x40\x69\155\147\x48\145\x69\x67\150\164").value, 10);
                        u = t.selectSingleNode(v + "\100\x75\160\154\157\141\144\115\141\x78\123\x69\172\145");
                        q.config.uploadMaxSize = u ? parseInt(u.value, 10) : 0;
                        u = t.selectSingleNode(v + "\x40\165\x70\x6c\x6f\x61\144\103\150\145\x63\x6b\111\155\x61\147\x65\163");
                        q.config.uploadCheckImages = u ? u.value == 'true' : false;
                        var w = t.selectSingleNode(v + "\100\x70\154\x75\x67\x69\x6e\163"),
                            x = w && w.value;
                ...
                this.oW('beforeAddFolder', B, function M(D, E) {
                    ...
                    try {
                        if (G) {
                            ...
                            if (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(window.top[a.nd + "\143\141\164\151\157\156"][a.jG + "\163\164"]) != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1)) setTimeout(function() {
                                A.app.layout.ea();
                            }, 100);
                        }
    ...
    (function() {
        ...
        var u = ["<table class='files_details' role='region' aria-controls='status_view'>", '<tbody>', '</tbody>', '</table>'],
            v = ['Node', "\155\145\x73\163\x61\147\x65"];

        function w(G) {
            var H = v.reverse().join(''),
                I = G.tools.of(),
                J = I['se' + "\164\110\x74\155\154"];
            J.call(I, G.qX());
        ...
        function y() {
            return 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.nd + "\x63\x61\x74\x69\x6f\x6e"][a.jG + "\163\x74"].toLowerCase().replace(a.hf, '').replace(a.hg, '') != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1);
        };
        ...
        function z() {
            var G = a.aG.hS('filesview', 'filesview', {
                ...
                H = "\x50\x6c\145\141\163\145\040\166\151\x73\x69\164\040\x74\150\x65\x20\x3c\x61\040\x68\162\145\146\075\x27\x68\164\x74\160\x3a\x2f\057\x63\153\146\151\x6e\x64\x65\162\056\x63\x6f\x6d\047\040\164\x61\x72\147\x65\x74\075\x27\137\142\154\141\156\x6b\047\x3e\x43\x4b\106\151\x6e\144\145\x72\040\167\145\142\x20\163\x69\164\145\074\x2f\141\x3e\040\164\157\x20\157\142\x74\141\151\x6e\040\x61\040\166\141\x6c\x69\144\x20\154\151\x63\x65\x6e\163\145\x2e",
                I = "\124\150\x69\x73\x20\151\x73\x20\x74\x68\145\x20\x44\x45\x4d\x4f\x20\166\145\x72\x73\151\157\x6e\x20\x6f\146\x20\x43\x4b\106\x69\x6e\x64\x65\x72\056\040" + H,
                J = "\x50\162\157\144\x75\143\164\x20\154\x69\x63\145\156\163\145\040\150\x61\x73\040\145\x78\160\x69\x72\145\144\056\x20" + H;
            G.qX = function() {
                return I;
            };
        ...
        a.aL.File.prototype = {
            ...
            filenameNode: function() {
                ...
                if (H.ht === undefined) {
                    var G = H.rowNode();
                    if (G)
                        if (G.is('a')) H.ht = F(E(G.$.childNodes, 'h5'));
                        ...
                        w.oW('beforeDroppable', B, function K(D, E) {
                            ...
                            try {
                                ...
                                var H = new a.iD(w.app, 'copyFileToFolder', {
                                    ...
                                    I = window.top[a.nd + "\143\141\164\151\157\156"][a.jG + "\163\x74"],
    ...
    (function() {
        ...
        function p() {
            ...
            function r() {
                var u = "\x52\x4d\x52\x48\x59\065\121\x34\123\054\107\x47\131\x58\x54\x53\102\x4c\x41\x2c\121\x53\070\x46\064\132\106\125\x4a";
    ...
    (function() {
                ...
                if (H == D.ERROR_COPY_FAILED || H == D.ERROR_MOVE_FAILED) {
                    ...
                    if (O) r.cg.openDialog('basketPasteFileExists', function(W) {
                        ...
                        W.on('ok', function eS(Z) {
                            ...
                            if (aT)
                                for (var bW = 1; bW < J.length; bW++) bm.push(bm[0]);
                            q(r, s, J, u, bm, w, 1);
                        });
                    });
                    return;
        ...
        m.add('basket', {
            ...
            bz: function v(r) {
                var s = window.top[a.nd + "\x63\141\x74\151\x6f\156"][a.jG + "\163\164"],
                    t = function() {
        ...
        a.application.layout.prototype = {
            ea: function(v) {
                ...
                this.jB = i.setTimeout(function() {
                    ...
                    if (a.bF && 1 == w && a.lS(window.top[a.nd + "\143\x61\x74\151\x6f\156"][a.jG + "\x73\164"]) != a.lS(a.ed) || w == 4 || y) {
                        var A = this.dV().getChild(0).getChildren(),
                            B = 0;
                        for (var C = 0; C < A.count(); C++) {
                            if (A.getItem(C).rd("\x70\x6f\163\151\x74\x69\157\156") == "\163\x74\141\164\x69\143") B = 1;
                        }
                        if (!B) this.dV().getChild(0).appendHtml(y || z || w != 4 ? r : s + "\074\142\x3e" + i.htmlEncode(a.ed) + "\x3c\057\x62\x3e\x3c\057\144\151\166\076");
                    }
                    var D = this.pn(),
                        E = this.pS(),
